  ...
  const experiences = [
    {
      ...
      period: '2023 - 2023',
      type: 'job',
      description: 'Developed responsive, cross-platform UIs for ServQuick POS, a SaaS web application for the restaurant industry. Led implementation of barcode printing and E-Way billing features, enhancing inventory management. Remediated 20+ SonarQube-identified security issues and mentored 3+ new team members on workflows and best practices.',
      technologies: ['Angular', 'Angular.js', 'TypeScript', 'Bootstrap', 'Jenkins'],
    },{
      role: 'Member Technical Staff - Front-end Developer',
