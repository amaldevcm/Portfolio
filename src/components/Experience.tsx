  ...
  const experiences = [
    {
      ...
      period: '2024 - Present',
      type: 'education',
      description: "Currently pursuing a Master of Science degree in computer science, focusing on advanced topics in computer vision and systems programming, while gaining hands-on experience through projects, coursework, and collaboration with peers.",
      ...
      period: '2023 - 2024',
      type: 'education',
      description: 'Completed a certification program to enhance data science skills, covering data analysis, machine learning, and Python-based tools like Tensorflow and Scikit-learn.',
      ...
      period: '2023 - 2023',
      type: 'job',
      description: 'Spearheaded Angular code migrations for Servquick and Go-Contactless web apps, enhancing performance, maintainability, and framework compatibility. Developed multilingual support (English and Spanish) to broaden accessibility, integrated government APIs for regulatory compliance, and provided mentorship to new team members during onboarding.',
